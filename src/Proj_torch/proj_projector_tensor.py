...
# The ProjProjector class in Python implements a projection method using orthogonal matrix
...
class ProjProjectorTensor:
    """
    A class that represents a projector for the Proj algorithm.
